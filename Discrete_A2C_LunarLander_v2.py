...
actor_dense = Dense(16,activation='relu')(dense4)
actor_output = Dense(num_actions,activation='softmax')(actor_dense)
critic_dense = Dense(16,activation='relu')(dense4)
...
a2c = Discrete_A2C.A2C(state_space=num_states,
                ...
                warm_up=100,
                iteration=10)# the size of replay buffer
...
#env = gym.make(env_name,enable_wind=True,render_mode='human')

total_reward_list,loss_list = a2c_agent.fit(env,episodes=8000)

...
dense1 = Dense(512,activation='relu')(actor_state_input)
dense2 = Dense(256,activation='relu')(dense1)
dense3 = Dense(64,activation='relu')(dense2)
actor_output = Dense(num_actions,activation='softmax')(dense3)
...
dense1 = Dense(512,activation='relu')(critic_state_input)
dense2 = Dense(256,activation='relu')(dense1)
dense3 = Dense(64,activation='relu')(dense2)
critic_output = Dense(1,activation='linear')(dense3)
...
ppo2 = PPO2.PPO2(state_space=num_states,
                ...
                iteration=20,
                warm_up=5,
                stop_score=160)# the size of replay buffer
